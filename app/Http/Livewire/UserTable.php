    ...
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('password_rule', function (User $model) {
                return strlen($model->password) < 3
                    ? ' <i class="fas fa-lock text-xs font-medium text-gray-500"></i>'
                    : '';
            })
            ->addColumn('job_title')
            ...
            ->addColumn('roles', function (User $model) {
                ...
                if ($roles) {
                    foreach ($roles as $role) {
                        $results[] = '<span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-50 text-gray-800">'
                                     . $role . '</span>';
                    }
                }
