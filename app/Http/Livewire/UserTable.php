...
final class UserTable extends PowerGridComponent
{
    ...
    */
    ...
    public function header(): array
    {
        return [
            ...
            Button::add('binding-modules-users')
                ...
                ->class('inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md text-sm mx-2 text-white tracking-widest hover:bg-gray-700 active:bg-gray-300 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 ml-0')
    ...
    public function openModalModules(): void
    {
        if (count($this->checkboxValues) == 0) {
            $this->dispatchBrowserEvent('showAlert', ['message' => 'Nepieciešams atlasīt vismaz vienu lietotāju!']);
        ...
        $this->dispatchBrowserEvent('showModal',
            [
                'message' => 'Atlasītie lietotāji: ' . $ids,
                'users' =>  $ids,
    ...
    */
    ...
    public function actionRules(): array
    {
        return [
            ...
            Rule::rows()
                ->when(fn($user) =>  isset($user->deleted_at))
