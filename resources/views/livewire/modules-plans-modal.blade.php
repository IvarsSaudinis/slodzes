    ...
    <div class="sm:flex sm:items-start p-7">
        ...
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                Pievienot atlasītos moduļus izvēlētājama plānam?
            </h3>
            <div class="mt-2">
                ...
                <p class="text-sm text-gray-500 mt-4">{{ $modules_count > 1 ? 'Atlasīti' : 'Atlasīts' }} {{ $modules_count }} {{ $modules_count > 1 ? 'moduļi' : 'modulis' }}</p>
            </div>
        </div>
    </div>
